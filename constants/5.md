...
$C\_{5}$ is the smallest constant such that Sidon sets in $\{1,\dots,N\}$ have cardinality $N^{1/2} + (C\_{5} + o(1))N^{1/4}$.
...
- [Li69] Lindstr\"{o}m, B., An inequality for $B\_{2}$-sequences. J. Combinatorial Theory (1969), 211-212.

...
$C\_{13a}$ is the infimal area of a **convex** domain $\Omega$ that can contain a rigid motion (translation + rotation; no reflections) of **every** planar arc (curve, or "worm") of length $1$.

...
- The reference [S2026] also provides a "bound on the bound" that shows that the limit of the "lattice and pigeonhole in a number field method" is $1 + \frac{1}{4.116} \approx 1.243$.
